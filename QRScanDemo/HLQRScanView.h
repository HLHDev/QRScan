...
typedef void(^HQRMyQRCodeBlock)(void);
typedef void(^HQRFlashSwitchBlock)(BOOL open);



@interface HLQRScanView : UIView

// 扫描器下方提示文字
@property (nonatomic, strong) UILabel *tipLab;

// 点击我的二维码的回调
@property (nonatomic,copy) HQRMyQRCodeBlock myQRCodeBlock;

// 打开/关闭闪光灯的回调
@property (nonatomic,copy) HQRFlashSwitchBlock flashSwitchBlock;
